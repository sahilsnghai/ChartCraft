...
class ScatterChart(BaseChart):
    ...
    def _get_series_with_multiple_dimensions(self) -> List[Dict[str, Any]]:
        ...
        data = [
            ...
            for d1, d2, x, y in zip(
                dimension1_values, dimension2_values, x_values, y_values
            )
        ]
    ...
    def _get_axis_config(self) -> Dict[str, Any]:
        ...
        return {"xAxis": axis_config.get_x_axis(), "yAxis": axis_config.get_y_axis()}
...
class BubbleChart(BaseChart):
    ...
    def _build_bubble_series(self) -> List[Dict[str, Any]]:
        ...
        if (
            self.config.get("radius")
            and self.config.get("dimension")
            and self.config.get("color")
        ):
    ...
    def _get_series_with_radius_dimension_color(self) -> List[Dict[str, Any]]:
        ...
        for color_value in color_values:
            ...
            data = [
                ...
                for dim, x, y, radius in zip(
                    dimension_values, x_values, y_values, radius_values
                )
            ]
    ...
    def _get_series_with_radius(self) -> List[Dict[str, Any]]:
        ...
        data = [
            [x, y, radius] for x, y, radius in zip(x_values, y_values, radius_values)
        ]
...
class SplitBubbleChart(BaseChart):
    ...
    def _build_split_bubble_series(self) -> List[Dict[str, Any]]:
        ...
        for color_value in color_values:
            ...
            data = [{"name": x, "value": y} for x, y in zip(x_values, y_values)]
